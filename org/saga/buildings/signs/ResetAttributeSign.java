...
public class ResetAttributeSign extends BuildingSign {
	 ...
	 *            building
	 */
	private ResetAttributeSign(Sign sign, String secondLine, String thirdLine,
	 ...
	 */
	public static ResetAttributeSign create(Sign sign, String secondLine,
			String thirdLine, String fourthLine, Building building) {
		return new ResetAttributeSign(sign, secondLine.toLowerCase(),
				thirdLine, fourthLine, building);
	}
