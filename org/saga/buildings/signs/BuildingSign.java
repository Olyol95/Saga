...
public abstract class BuildingSign extends SagaCustomSerialization {
	 ...
	 *            building
	 */
	protected BuildingSign(Sign sign, String firstLine, String secondLine,
	...
	public void setLines(Sign sign) {
		...
		case ENABLED:
			...
			sign.setLine(0, SettlementConfiguration.config().enabledSignColor
					+ getName());
			break;

		case DISABLED:

			sign.setLine(0, SettlementConfiguration.config().disabledSignColor
					+ getName());
			break;

		case INVALIDATED:

			sign.setLine(0, SettlementConfiguration.config().invalidSignColor
					+ getName());
			break;
	 ...
	 *            event
	 */
	public final void onPlayerInteract(SagaPlayer sagaPlayer,
