...
public class Ignite extends Ability {
	...
	public boolean triggerAttack(SagaDamageEvent event) {
		...
		// Only fireball:
		if (!(event.getProjectile() instanceof org.bukkit.entity.Fireball))
			return false;

		// Duration:
		Integer duration = getDefinition().getFunction(DURATION_KEY)
		...
		if (defenderPlayer != null) {
			...
			defenderCreature.setFireTicks(defenderCreature.getFireTicks()
					+ duration);
