...
public class Silent extends Ability {
	 ...
	 * 
	 * @see
	 * org.saga.abilities.Ability#handleTargetedPreTrigger(org.bukkit.event.
	 ...
	 * 
	 * @see org.saga.abilities.Ability#triggerTargeted(org.bukkit.event.entity.
	 * EntityTargetEvent)
	 */
	@Override
	public boolean triggerTargeted(EntityTargetEvent event) {
		...
		Double maxDistance = VanillaConfiguration.getTargetDistance(event
				.getEntity())
				* getDefinition()
						.getFunction(DETECTION_DISTANCE_MULTIPLIER_KEY).value(
								getScore());
		Double maxDistanceSq = maxDistance * maxDistance;

		Double distanceSq = event.getEntity().getLocation()
				.distanceSquared(event.getTarget().getLocation());
