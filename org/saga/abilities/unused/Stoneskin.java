...
public class Stoneskin extends Ability {
	...
	// * (non-Javadoc)
	// * @see
	// org.saga.abilities.Ability#onHitByPlayer(org.bukkit.event.entity.EntityDamageByEntityEvent,
	// org.saga.player.SagaPlayer)
	// */
	// @Override
	// public boolean onHitByPlayer(EntityDamageByEntityEvent event, SagaPlayer
	// attacker) {
	//
	//
	// // Check pre use:
	...
	// * (non-Javadoc)
	// * @see
	// org.saga.abilities.Ability#onHitByCreature(org.bukkit.event.entity.EntityDamageByEntityEvent,
	// org.bukkit.entity.Creature)
	// */
	// @Override
	// public boolean onHitByCreature(EntityDamageByEntityEvent event, Creature
	// creature) {
	//
	//
	// // Check pre use:
	...
	// * (non-Javadoc)
	// * @see
	// org.saga.abilities.Ability#onShotByPlayer(org.bukkit.event.entity.EntityDamageByEntityEvent,
	// org.saga.player.SagaPlayer, org.bukkit.entity.Projectile)
	// */
	// @Override
	// public boolean onShotByPlayer(EntityDamageByEntityEvent event, SagaPlayer
	// attacker, Projectile projectile) {
	//
	//
	// // Check pre use:
	// if(!handlePreUse()){
	...
	// * (non-Javadoc)
	// * @see
	// org.saga.abilities.Ability#onShotCreature(org.bukkit.event.entity.EntityDamageByEntityEvent,
	// org.bukkit.entity.Creature, org.bukkit.entity.Projectile)
	// */
	// @Override
	// public boolean onShotByCreature(EntityDamageByEntityEvent event, Creature
	// creature, Projectile projectile) {
	//
	//
	// // Check pre use:
	// if(!handlePreUse()){
	...
	// * (non-Javadoc)
	// * @see
	// org.saga.abilities.Ability#onSpelledByPlayer(org.bukkit.event.entity.EntityDamageByEntityEvent,
	// org.saga.player.SagaPlayer, org.bukkit.entity.Projectile)
	// */
	// @Override
	// public boolean onSpelledByPlayer(EntityDamageByEntityEvent event,
	// SagaPlayer defender, Projectile projectile) {
	//
	//
	// // Check pre use:
	// if(!handlePreUse()){
	...
	//
	// Double damageMult = 1 -
	// getDefinition().getPrimaryFunction().value(getSkillLevel());
	//
	// // Normalize:
	// if(damageMult < 0){
	...
	//
	// // Reduce damage;
	// event.setDamage(TwoPointFunction.randomRound(event.getDamage() *
	// damageMult));
	//
	// // Play effect:
	// playeEffect(getSagaPlayer());
	...
	// case HEAVY:
	//
	// return PlayerMessages.negative + TextUtil.capitalize(getName()) +
	// " can't be used with heavy armour.";
	//
	// case EXOTIC:
	//
	// return PlayerMessages.negative + TextUtil.capitalize(getName()) +
	// " can't be used with exotic armour.";
	//
	// default:
