...
public class AttributeConfiguration {
	...
	/**
	 * Damage penalty totals. If Minecraft damage is below these values, then a
	 * penalty is applied to the resulting damage.
	 */
	...
	public static AttributeConfiguration load() {
		...
		if (!WriterReader.checkExists(Directory.ATTRIBUTE_CONFIG)) {
			...
			try {
				...
				SagaLogger.severe(AttributeConfiguration.class,
		...
		try {
			...
			config = WriterReader.readConfig(Directory.ATTRIBUTE_CONFIG,
