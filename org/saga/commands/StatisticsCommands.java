...
public class StatisticsCommands {
	...
	public static void xrayIndication(CommandContext args, Saga plugin,
		...
		for (String name : allNames) {
			...
			// Ratio:
			Double ratio = StatisticsManager.manager().getVeinRatio(name,
					material);
			if (ratio < GeneralConfiguration.config().getXrayDiamondRatio())
				continue;

			// Mined stone:
			if (StatisticsManager.manager().getFoundVeins(name, Material.STONE) < GeneralConfiguration
					.config().getXrayMinStone())
				continue;
		...
		sagaPlayer.message(StatisticsMessages.xrayIndication(
				suspects.toArray(new String[suspects.size()]),
				ratios.toArray(new Double[ratios.size()]),
				veins.toArray(new Integer[veins.size()])));
	...
	public static void xrayConfirm(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
		...
		// Confirm:
		Double ratio = StatisticsManager.manager().getVeinRatio(playerName,
				Material.DIAMOND_ORE);
		StatisticsManager.manager().confirmXray(playerName,
				Material.DIAMOND_ORE, ratio);
	...
	public static void exp(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
		...
		sagaPlayer.message(StatisticsMessages.statisticsAge(StatisticsManager
				.manager().calcStatisticsAge()));

	}

	@Command(aliases = { "stattributes", "stattr" }, usage = "", flags = "", desc = "Show trained attributes statistics.", min = 0, max = 0)
	@CommandPermissions({ "saga.statistics.stats.attributes" })
	public static void attributes(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Inform:
		sagaPlayer.message(StatisticsMessages.values("attributes trained",
				"attributes.trained", "attribute", "score sum", true, 0, 0));
	...
	@Command(aliases = { "stabilities", "stabil" }, usage = "", flags = "", desc = "Show trained abilities statistics.", min = 0, max = 0)
	@CommandPermissions({ "saga.statistics.stats.abilities" })
	public static void abilities(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Inform:
		sagaPlayer.message(StatisticsMessages.values("abilities trained",
				"abilities.trained", "ability", "score sum", true, 0, 0));
	...
	@Command(aliases = { "stusedabilities", "stabiluse" }, usage = "", flags = "", desc = "Show used abilities statistics.", min = 0, max = 0)
	@CommandPermissions({ "saga.statistics.stats.usedabilities" })
	public static void usedAbilities(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Inform:
		sagaPlayer.message(StatisticsMessages.values("abilities used",
				"abilities.used", "ability", "uses sum", true, 0, 0));
	...
	public static void roles(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Inform:
		sagaPlayer.message(StatisticsMessages.values("roles",
				"settlements.roles.used", "used", "available", "role", "used",
				"available", !args.hasFlag('a'), 0, 0));
	...
	public static void ranks(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Inform:
		sagaPlayer.message(StatisticsMessages.values("ranks",
				"factions.ranks.used", "used", "available", "rank", "used",
				"available", !args.hasFlag('a'), 0, 0));
	...
	public static void balance(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
	...
	public static void wages(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Inform:
		sagaPlayer.message(StatisticsMessages.values("wages", "wages.factions",
				"rank", "wages sum", !args.hasFlag('a'), 0, 0));
	...
	public static void buildings(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Inform:
		sagaPlayer.message(StatisticsMessages.values("buildings set",
				"buildings.set", "building", "set sum", true, 0, 0));
	...
	public static void claimed(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Inform:
		sagaPlayer.message(StatisticsMessages.values("faction claiming",
				"faction_claiming", "action", "sum", !args.hasFlag('a'), 0, 0));
	...
	public static void xrayHistogram(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
		...
		// Inform:
		sagaPlayer.message(StatisticsMessages.histogram("x-ray histogram: "
				+ GeneralMessages.material(material), data, 10, 3));
	...
	public static void attributesHistogram(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Data:
		Double[] data = StatisticsManager.manager().createHistogramData(
				"attributes.trained");

		// Inform:
		sagaPlayer.message(StatisticsMessages.histogram(
				"trained attribute points histogram", data, 10, 0));
	...
	@Command(aliases = { "stabilhist" }, usage = "", flags = "", desc = "Show spent ability distribution histogram.", min = 0, max = 0)
	@CommandPermissions({ "saga.statistics.histogram.abilities" })
	public static void abilityHistogram(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
		...
		// Inform:
		sagaPlayer.message(StatisticsMessages.histogram(
				"trained ability points histogram", data, 10, 0));
	...
	public static void sclaimsHistogram(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
		...
		// Inform:
		sagaPlayer.message(StatisticsMessages.histogram(
				"settlement claims histogram", data, 10, 0));
	...
	public static void sizeHistogram(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
		...
		// Inform:
		sagaPlayer.message(StatisticsMessages.histogram(
				"settlement size histogram", data, 10, 0));
	...
	public static void flevelsHistogram(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
		...
		// Inform:
		sagaPlayer.message(StatisticsMessages.histogram(
				"faction claims histogram", data, 10, 0));
	...
	public static void walletHistogram(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
		...
		// Inform:
		sagaPlayer.message(StatisticsMessages.histogram("wallet histogram",
				data, 10, 1, MetricPrefix.k));
	...
	public static void reset(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
	...
	public static void updatePlayers(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
	...
	public static void online(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {

		// Inform:
		sagaPlayer.message(StatisticsMessages.values("online claims", "online",
				"online", "claims", "group", "minutes", "claims",
				!args.hasFlag('a'), 0, 0));
	...
	public static void general(CommandContext args, Saga plugin,
			SagaPlayer sagaPlayer) {
