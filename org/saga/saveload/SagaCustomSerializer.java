 ...
 * @author Cory
 */
public class SagaCustomSerializer implements
		JsonSerializer<SagaCustomSerialization>,
		JsonDeserializer<SagaCustomSerialization> {

	public SagaCustomSerialization deserialize(JsonElement je, Type type,
	...
	public JsonElement serialize(SagaCustomSerialization t, Type type,
