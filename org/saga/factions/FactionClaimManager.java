...
public class FactionClaimManager implements SecondTicker {
	...
	public void complete() {
		...
		// removeFaction(id);
		// SagaLogger.warning(getClass(), "faction with ID " + id +
		// " doesn't exist");
		// }
		// }
		//
	...
	// */
	// public static Integer getInitFactonId(Integer bundleId,
	// ArrayList<SagaPlayer> sagaPlayers) {
	//
	//
	// Integer owningId =
	// FactionClaimManager.manager().getOwningFactionId(bundleId);
	//
	// // Get faction:
	...
	// */
	// public static HashSet<Integer> getAllFactionIds(ArrayList<SagaPlayer>
	// sagaPlayers) {
	//
	//
	...
	// allClaimers.add(sagaPlayer.getFaction().getId());
	// }
	//
	// return allClaimers;
	//
	...
	// * @return initiating faction ID, null if none
	// */
	// public static Faction getInitFacton(Integer bundleId,
	// ArrayList<SagaPlayer> sagaPlayers) {
	//
	//
	...
	// if(bundle == null){
	// SagaLogger.severe(getClass(), "failed to retrieve chunk bundle for " +
	// bundleId);
	// progress.remove(bundleId);
	// claiming.remove(bundleId);
	// continue;
	...
	//
	// Double decrease = FactionConfiguration.config().getUnclaimSpeed(size) /
	// 60;
	...
	// */
	// public boolean checkAvailable(Integer bundleId, ArrayList<SagaPlayer>
	// sagaPlayers) {
	//
	//
	// Integer initId = getInitFactonId(bundleId, sagaPlayers);
	...
	// */
	// public boolean checkClaimer(Integer bundleId, ArrayList<SagaPlayer>
	// sagaPlayers) {
	//
	//
	...
	public static FactionClaimManager load() {
		...
		// Load:
			...
			try {
				...
				instance = WriterReader.read(Directory.FACTION_CLAIMS,
						FactionClaimManager.class);
				...
				SagaLogger
						.severe(FileNotFoundException.class, "failed to load");
				instance = new FactionClaimManager("");

			} catch (JsonParseException e) {

				SagaLogger.severe(FileNotFoundException.class,
						"failed to parse");
