...
public enum DamageType {
	...
	MELEE, RANGED, MAGIC, BURN, FALL, OTHER;
	...
	public static DamageType getDamageType(EntityDamageEvent event) {
		...
		if (event instanceof EntityDamageByEntityEvent) {
			...
			// Fireball:
			if (edbye.getDamager() instanceof Fireball)
				return MAGIC;

			// Lightning:
			if (edbye.getCause() == DamageCause.LIGHTNING)
				return OTHER;

			// Melee:
			if (edbye.getCause() == DamageCause.ENTITY_ATTACK)
				return MELEE;
