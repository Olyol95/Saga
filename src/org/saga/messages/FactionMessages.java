...
public class FactionMessages {
	...
	public static String disbandedOther(Faction faction) {
		return faction.getColour2() + "Disbanded " + faction(faction)
				+ " faction.";
	}

	// Naming:
	public static String invalidName() {
		return Colour.negative + "Name must be "
				+ FactionConfiguration.config().getMinNameLength() + "-"
				+ FactionConfiguration.config().getMaxNameLength()
				+ " characters long and only contain letters and numbers.";
	}
	...
	public static String renamed(Faction faction) {
		...
		return faction.getColour2() + "Faction was renamed to "
				+ faction(faction) + ".";
	...
	public static String notMember(Faction faction, String selName) {
		return Colour.negative + "Player " + selName
				+ " isn't a member of the faction.";
	}
	...
	public static String informInvited() {
		return Colour.normal1
				+ "Use /faccept to accept the faction join invitation.";
	}
	...
	public static String wasInvited(SagaPlayer sagaPlayer, Faction faction) {
		return faction.getColour2() + "You were invited to "
				+ faction.getColour1() + faction.getName()
				+ faction.getColour2() + " faction.";
	}

	public static String invited(SagaPlayer sagaPlayer, Faction faction) {
		return faction.getColour2() + "" + sagaPlayer.getName()
				+ " was invited to the faction.";
	}

	public static String haveJoined(SagaPlayer sagaPlayer, Faction faction) {
		return faction.getColour2() + "Joined " + faction.getColour1()
				+ faction.getName() + faction.getColour2() + " faction.";
	}
	...
	public static String newOwner(Faction faction, String name) {
		return faction.getColour2() + "Player " + name
				+ " is the new owner of the faction.";
	}
	...
	public static String ownerCantQuitInfo() {
		return Colour.normal1
				+ "Use /fresign to declare someone else as the owner.";
	}
	...
	public static String notFormedInfo(Faction faction) {
		...
		return Colour.normal1 + "The faction requires " + result.toString()
				+ " to form.";
	...
	public static String colour1Set(Faction faction) {
		...
		return faction.getColour2() + "Factions colour I set to "
				+ faction.getColour1() + ChatUtil.colour(faction.getColour1())
				+ faction.getColour2() + ".";
	...
	public static String colour2Set(Faction faction) {
		...
		return faction.getColour2() + "Factions colour II set to "
				+ faction.getColour2() + ChatUtil.colour(faction.getColour2())
				+ faction.getColour2() + ".";

	}

	public static String invalidColor(String colourName) {
		return Colour.negative + "Colour " + colourName
	...
	public static String recievedAllianceInfo(Faction faction, Faction target) {
		...
		return Colour.normal1
				+ "Use /fallyaccept to accept and /fallydecline to decline the alliance request.";
	...
	public static String selfAlliance(Faction faction) {
		...
		return Colour.negative
				+ "Can't request an alliance from your own faction.";

	}

	public static String alreadyAlliance(Faction faction, Faction targetFaction) {

		return Colour.negative + "An alliance with " + faction(targetFaction)
				+ " is already formed.";
	...
	public static String noAllianceRequest(Faction faction, String souceFaction) {
		...
		return Colour.negative
				+ "The faction doesn't have an alliance request from "
				+ souceFaction + " faction.";

	}

	public static String noAlliance(Faction faction, Faction targetFaction) {

		return Colour.negative + "No alliance formed with "
	...
	public static String isAllyDeny(Faction faction, Faction target) {
		return Colour.negative + "The faction " + faction(target)
				+ " is an ally.";
	}

	// Rank:
	public static String newRank(Faction faction, String rankName,
			SagaPlayer targetPlayer) {

		return faction.getColour2() + "Rank " + rankName + " was assigned to "
	...
	public static String notClaimed(Faction faction, Bundle bundle) {
		return Colour.negative + "Settlement " + bundle.getName()
				+ " is not claimed by the faction.";
	}

	public static String unclaimed(Faction faction, Bundle bundle) {
		return faction.getColour2() + "Settlement " + bundle.getName()
				+ " was unclaimed.";
	}
	...
	public static String wrongQuit() {
		...
		return Colour.negative
				+ "Because /squit and /fquit are similar, this command isn't used. Please use /factionquit instead.";
	...
	public static String faction(Faction faction) {
		...
		return faction.getColour1() + faction.getName()
				+ CustomColour.PREVIOUS_COLOR;

	}

	public static String faction(ChatColor format, Faction faction) {

		return faction.getColour1().toString() + format + faction.getName()
				+ CustomColour.PREVIOUS_COLOR + format;
