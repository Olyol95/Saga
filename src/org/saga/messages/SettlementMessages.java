...
public class SettlementMessages {
	...
	public static String settled(SagaPlayer sagaPlayer, Bundle settlement) {
		return Colour.normal1 + "Founded " + settlement.getName()
				+ " settlement.";
	}

	public static String dissolved(Bundle settlement) {
		return Colour.normal1 + "Dissolved " + settlement.getName()
				+ " settlement.";
	}
	...
	public static String invalidName() {
		return Colour.negative + "Settlement name must be  "
				+ SettlementConfiguration.config().getMinNameLength() + "-"
				+ SettlementConfiguration.config().getMaxNameLength()
				+ ". Letters and numbers only.";
	}

	public static String inUse(String name) {
		return Colour.negative + "Settlement name " + name
				+ " is already in use.";
	}
	...
	public static String claimed(SagaChunk sagaChunk, Bundle bundle) {
		return Colour.normal1 + "Claimed chunk for " + bundle.getName()
				+ " settlement.";
	}
	...
	public static String abandoned(SagaChunk sagaChunk, Bundle bundle) {
		return Colour.normal1 + "Abandoned chunk from " + bundle.getName()
				+ " settlement.";
	}
	...
	public static String chunkMustBeAdjacent() {
		return Colour.negative
				+ "You can only claim chunks adjacent to an existing settlement.";
	}

	public static String claimAdjacentDeny() {
		return Colour.negative
				+ "Can't claim land adjacent to other settlements.";
	}
	...
	public static String setBuilding(Building building, Bundle bundle) {
		return Colour.normal1 + "Set " + building.getName() + " building for "
				+ bundle.getName() + " settlement.";
	}
	...
	public static String removedBuilding(Building building, Bundle bundle) {
		return Colour.normal1 + "Removed " + building.getName()
				+ " building from " + bundle.getName() + " settlement.";
	}
	...
	public static String notMember(Bundle bundle) {
		return Colour.negative + "You aren't a member of " + bundle.getName()
				+ " settlement.";
	}

	public static String notMember(Bundle bundle, String name) {
		return Colour.negative + "Player " + name
				+ " isn't a member of the settlement.";
	}
	...
	public static String alreadyInSettlement(SagaPlayer selPlayer) {
		return Colour.negative + "Player " + selPlayer.getName()
				+ " is already in a settlement.";
	}
	...
	public static String noInvites(String factionName) {
		return Colour.negative + "You don't have an invitation to "
				+ factionName + " settlement.";
	}

	public static String cantKickYourself(SagaPlayer sagaPlayer,
			Bundle settlement) {
	...
	public static String alreadyInvited(SagaPlayer sagaPlayer, Bundle group) {
		return Colour.negative + sagaPlayer.getName()
				+ " is already invited to the settlement.";
	}

	public static String notMember(SagaPlayer sagaPlayer, Bundle bundle) {
		return Colour.negative + "Player " + sagaPlayer.getName()
				+ " isn't a member of the settlement.";
	}
	...
	public static String declinedInvite(Bundle bundle) {
		return Colour.normal1 + "Declined a join invitation from "
				+ bundle.getName() + " settlement.";
	}
	...
	public static String haveQuit(SagaPlayer sagaPlayer, Bundle settlement) {
		return Colour.normal1 + "Quit from " + settlement.getName()
				+ " settlement.";
	}
	...
	public static String wasKicked(SagaPlayer sagaPlayer, Bundle settlement) {
		return Colour.normal1 + "You were kicked out of "
				+ settlement.getName() + " settlement.";
	}

	public static String kicked(SagaPlayer sagaPlayer, Bundle settlement) {
		return Colour.normal2 + sagaPlayer.getName()
				+ " was kicked from the settlement.";
	}

	// Owner:
	public static String newOwner(String name) {
		return Colour.normal2 + "Player " + name
				+ " is the new owner of the settlement.";
	}
	...
	public static String alreadyOwner(String name) {
		return Colour.negative + "Player " + name
				+ " is already the settlement owner.";
	}
	...
	public static String ownerCantQuitInfo() {
		return Colour.normal1
				+ "Use /sresign to declare someone else as the owner.";
	}
	...
	public static String newRole(SagaPlayer sagaPlayer, Bundle settlement,
			String roleName) {
	...
	public static String roledPlayer(Settlement settlement,
	...
	public static String optionToggle(Bundle bundle, BundleToggleable option) {
		...
		if (bundle.isOptionEnabled(option)) {
			return Colour.positive + "Enabled " + option + " for "
					+ bundle.getName() + ".";
		} else {
			return Colour.positive + "Disabled " + option + " for "
					+ bundle.getName() + ".";
		}

	}

	public static String optionAlreadyEnabled(Bundle bundle,
			BundleToggleable option) {

		return Colour.negative + "Option " + option.toString()
				+ " is already enabled for " + bundle.getName()
				+ " settlement.";

	}

	public static String optionAlreadyDisabled(Bundle bundle,
			BundleToggleable option) {

		return Colour.negative + "Option " + option.toString()
				+ " is already disabled for " + bundle.getName()
				+ " settlement.";
	...
	public static String optionInvalidInfo() {
		...
		return Colour.normal1 + "Valid options: "
				+ ChatUtil.flatten(validOptions) + ".";
	...
	public static String entered(Bundle bundle) {
		...
		// Claimed:
		Faction faction = SiegeManager.manager().getOwningFaction(
				bundle.getId());
		if (faction != null) {
			return Colour.normal1 + "[" + FactionMessages.faction(faction)
					+ "]" + ChatColor.ITALIC + " Entered " + bundle.getName()
					+ " settlement.";
		}

		return Colour.normal1 + "" + ChatColor.ITALIC + "Entered "
				+ bundle.getName() + " settlement.";
	...
	public static String left(Bundle bundle) {
		...
		if (faction != null) {
			return Colour.normal1 + "[" + FactionMessages.faction(faction)
					+ "]" + ChatColor.ITALIC + " Left " + bundle.getName()
					+ " settlement.";
		}

		return Colour.normal1 + "" + ChatColor.ITALIC + "Left "
				+ bundle.getName() + " settlement.";
	...
	public static String wrongQuit() {
		...
		return Colour.negative
				+ "Because /squit and /fquit are similar, this command isn't used. Please use /settlementquit instead.";
