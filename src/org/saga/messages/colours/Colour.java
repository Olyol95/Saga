...
public class Colour {
	...
	public static ChatColor veryPositive = ChatColor.DARK_GREEN; // DO NOT
																	// OVERUSE.
	...
	public static ChatColor veryNegative = ChatColor.DARK_RED; // DO NOT
																// OVERUSE.
		...
		public static String process(String message) {
			...
			for (int i = 0; i < message.length(); i++) {
				...
				if (c == ChatColor.COLOR_CHAR && i + 1 < message.length()) {
					...
					ChatColor nextCol = ChatColor.getByChar(message
							.charAt(i + 1));
					if (nextCol != null && nextCol.isColor())
						cols.push(nextCol);
