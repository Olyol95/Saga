...
public class ChatFramer {
	 ...
	 */
	public final static Double MAX_CONTENTS_WIDTH = ChatFiller.CHAT_WIDTH
			- ChatFiller
	...
	// Frame:
	public static String frame(String title, String message, ChatColor colour,
			double width) {
		...
		double length = (ChatFiller.CHAT_WIDTH - ChatFiller
				.calcLength(FRAME_VERTICAL + " " + " " + FRAME_VERTICAL))
				* width;
		...
		// Adjust width:
		length = ChatFiller.calcLength(frameBottom.toString())
				- ChatFiller.calcLength(" " + " " + FRAME_VERTICAL
						+ FRAME_VERTICAL) + CONTENT_CENTRING_FIX;
