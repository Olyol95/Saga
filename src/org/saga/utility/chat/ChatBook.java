...
public class ChatBook {
	 ...
	 *            book title
	 * @param width
	 *            book width of total chat width
	 * @param colours
	 *            book sect colours
	 */
	 ...
	 *            line
	 * @param allowBreak
	 *            true if breaking into sections is allowed
	 */
	public void add(String line, boolean allowBreak) {
		...
		// Long sections:
		if (allowBreak
				&& ChatFiller.MAX_LENGTH * line.length() > ChatFramer.MAX_CONTENTS_WIDTH) {
	...
	public String framedPage(Integer page) {
		...
		if (lastPage != 0)
			title += ", " + GeneralMessages.page(page, lastPage);
