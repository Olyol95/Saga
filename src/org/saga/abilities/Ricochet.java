...
public class Ricochet extends Ability {
	 ...
	 * 
	 * @see
	 * org.saga.abilities.Ability#handleProjectileHitPreTrigger(org.bukkit.event
	...
	public boolean triggerProjectileHit(ProjectileHitEvent event) {
		...
		double radius = getDefinition().getFunction(RANGE_KEY)
				.value(getScore());
	...
	private void handleRicochet() {
		...
		Arrow newArrow = origLoc.getWorld().spawnArrow(origLoc, velocity,
				speed, 0);
