...
public class SagaBuildEvent {
	...
	public BuildOverride getbuildOverride() {
		...
		if (buildOverride.size() == 0)
			return BuildOverride.NONE;
	...
	public enum BuildOverride {
		...
		ADMIN_ALLOW(true), ADMIN_DENY(false),

		CRUMBLE_ARENA_DENY(false),

		OPEN_CLAIMED_STORAGE_AREA_ALLOW(true), OPEN_STORAGE_AREA_ALLOW(true), STORAGE_AREA_DENY(
				false),
		...
		HOME_RESIDENT_ALLOW(true), HOME_DENY(false),

		BUILDING_DENY(false), SETTLEMENT_DENY(false), WILDERNESS_SPECIFIC_BLOCK_ALLOW(
				true), WILDERNESS_DENY(false),
