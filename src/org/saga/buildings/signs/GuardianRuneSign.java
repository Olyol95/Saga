...
public class GuardianRuneSign extends BuildingSign {
	 ...
	 *            building
	 */
	private GuardianRuneSign(Sign sign, String secondLine, String thirdLine,
	 ...
	 */
	public static GuardianRuneSign create(Sign sign, String secondLine,
			String thirdLine, String fourthLine, Building building) {
		return new GuardianRuneSign(sign, secondLine, thirdLine, fourthLine,
				building);
	}
