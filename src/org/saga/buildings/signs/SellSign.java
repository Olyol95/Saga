...
public class SellSign extends BuildingSign {
	 ...
	 *            building
	 */
	protected SellSign(Sign sign, String secondLine, String thirdLine,
	 ...
	 */
	public static SellSign create(Sign sign, String secondLine,
		...
		case ENABLED:
			...
			if (index == 3)
				return coins.intValue() + "/"
						+ EconomyMessages.coins((double) maxCoins.intValue());
	...
	protected void onRightClick(SagaPlayer sagaPlayer) {
		...
		// Statistics:
		StatisticsManager.manager().addSell(sagaPlayer, item.getType(),
