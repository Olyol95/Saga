...
public class ResetAbilitySign extends BuildingSign {
	 ...
	 *            building
	 */
	private ResetAbilitySign(Sign sign, String secondLine, String thirdLine,
	 ...
	 */
	public static ResetAbilitySign create(Sign sign, String secondLine,
			String thirdLine, String fourthLine, Building building) {
		return new ResetAbilitySign(sign, secondLine.toLowerCase(), thirdLine,
				fourthLine, building);
	}
	...
	public SignStatus getStatus() {
		...
		if (AbilityConfiguration.config().getDefinition(abilName) == null
				|| amount == -1)
	...
	protected void onRightClick(SagaPlayer sagaPlayer) {
		...
		if (ability == null) {
			SagaLogger.severe(this, "failed to retrieve " + abilName
