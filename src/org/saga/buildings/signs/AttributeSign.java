...
public class AttributeSign extends BuildingSign {
	 ...
	 *            building
	 */
	private AttributeSign(Sign sign, String secondLine, String thirdLine,
			String fourthLine, Building building) {

		super(sign, SIGN_NAME, secondLine.toLowerCase(), thirdLine, fourthLine,
				building);
	 ...
	 */
	public static AttributeSign create(Sign sign, String secondLine,
			String thirdLine, String fourthLine, Building building) {
		return new AttributeSign(sign, secondLine, thirdLine, fourthLine,
				building);
	}
	...
	protected void onRightClick(SagaPlayer sagaPlayer) {
		...
		if (nextScore > scoreCap) {
			sagaPlayer.message(BuildingMessages.attributeMaxReached(attrName,
					scoreCap));
			return;
		}
		...
		if (sagaPlayer.getRemainingAttributePoints() < 1) {
			sagaPlayer.message(BuildingMessages
					.attributePointsRequired(attrName));
			return;
		}
		...
		// Inform:
		sagaPlayer.message(BuildingMessages.attributeTrained(attrName,
				nextScore));
