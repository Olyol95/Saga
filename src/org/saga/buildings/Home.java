...
public class Home extends Building {
	...
	public boolean isResident(String playerName) {
		...
		return residents.contains(playerName)
				|| residents.contains(playerName.toLowerCase());
	...
	public void addResident(String playerName) {
		...
		if (isResident(playerName.toLowerCase())) {
			SagaLogger
					.severe(this, "tried to add an already existing resident");
			return;
		}
	...
	public void onBuild(SagaBuildEvent event) {
		...
		if (isResident(sagaPlayer.getName())
				|| getChunkBundle().isOwner(sagaPlayer.getName())
