...
public class GeneralConfiguration {
	...
	public void complete() {
		...
		if (randomTPCentre == null || randomTPCentre.length != 2) {
			SagaLogger.nullField(getClass(), "randomTPCentre");
	...
	public static GeneralConfiguration load() {
		...
		if (!WriterReader.checkExists(Directory.GENERAL_CONFIG)) {
			...
			try {
				...
				SagaLogger.severe(GeneralConfiguration.class,
		...
		try {
			...
			config = WriterReader.readConfig(Directory.GENERAL_CONFIG,
